...
import com.example.uas_10119242.presenter.SplashPresenter;
...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent intent = new Intent(SplashActivity.this, com.example.uas_10119242.activities.SlideActivity.class);
