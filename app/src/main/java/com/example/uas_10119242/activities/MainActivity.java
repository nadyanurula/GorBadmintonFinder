...
import com.example.uas_10119242.adapter.MainAdapter;
import com.example.uas_10119242.layout.LayoutMarginDecoration;
import com.example.uas_10119242.model.MainModel;
import com.example.uas_10119242.presenter.MainSlidePresenter;
...
public class MainActivity extends AppCompatActivity implements MainAdapter.onSelectData, NavigationView.OnNavigationItemSelectedListener {
    ...
    private void setMenu() {
        mdlMainMenu = new MainModel("Gor", R.drawable.bulu2);
    ...
    public void onSelected(MainModel mdlMain) {
        switch (mdlMain.getTxtName()) {
            case "Gor":
                Intent i = new Intent(MainActivity.this, GorActivity.class);
                startActivity(i);
                break;
        }
    }
    ...
    public boolean onNavigationItemSelected(@NonNull final MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.nav_about:
                ...
                builder.setMessage("Aplikasi untuk menemukan GOR Badminton di Bandung Raya");
